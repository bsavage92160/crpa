...
(function($) {
  ...
  **/
  ...
  ColorPicker.prototype.createSwatch = function(index, color, optTxt) {
  ...
  **/
  ColorPicker.prototype.getColorIndex = function(color) {
  ...
  **/
  ColorPicker.prototype.buildPalette = function(colors, optTxts) {
    var self = this;
    var swatch;
